package pl.niewadzj.moneyExchange.api.message.constants;

public final class MessageMappings {

    public static final String MESSAGE_MAPPING = "/api/v1/message";
    public static final String CREATE_DATE_MESSAGE = "/createDateMessage";
